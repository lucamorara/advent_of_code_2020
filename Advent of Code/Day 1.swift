    ...
    for x in input {
        for y in input {
            if input.contains(2020 - x - y) {
                let z = input.first(where: { $0 == (2020 - x - y) })!
